import 'package:app_coures/controllers/profile_controller.dart';
import 'package:app_coures/models/user_model.dart';
import 'package:flutter/material.dart';


class ProfilePage extends StatefulWidget {  // Changed from Profile to ProfilePage
  ...
  Widget _buildProfileHeader(User user) {
    return Container(
      ...
      decoration: const BoxDecoration(
        color: Color.fromARGB(255, 85, 148, 87),
          ...
          children: [
            Container(
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: Colors.black.withOpacity(0.2), // FIXED
                    spreadRadius: 2,
                    blurRadius: 10,
                  ),
                ],
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              _buildProfileField('Full Name', Icons.person, _firstNameController),
              const SizedBox(height: 16),
